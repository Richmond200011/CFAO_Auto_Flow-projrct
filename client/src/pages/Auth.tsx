    ...
    <div className="min-h-screen w-full flex items-center justify-center bg-slate-900 relative overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        ...
        <div
          ...
          style={{
            backgroundImage:
              "url(https://images.unsplash.com/photo-1487754180451-c456f719a1fc?q=80&w=2070)",
          }}
        />
      ...
      >
        <div className="text-center mb-8">
          ...
          <p className="text-slate-300 mt-2 font-light">
            CFAO Mobility Management Portal
          </p>
        </div>
          ...
          <CardContent>
            <form onSubmit={handleLogin} className="space-y-4">
              ...
              <div className="flex justify-end">
                <a
                  href="#"
                  className="text-xs text-primary-foreground/80 hover:text-white hover:underline"
                >
                  Forgot Password?
                </a>
              </div>
